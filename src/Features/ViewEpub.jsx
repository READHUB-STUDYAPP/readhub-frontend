    ...
    >
      ...
      >
        <div className="flex items-center">
          {/*
            A real target, not a bare glyph.

            This was a 24px icon with nothing around it -- under half the 44px
            a finger needs, and with no hover or focus state to say it could be
            pressed at all, which is why it read as decoration rather than the
            way out of the book.
          */}
          <button
            type="button"
            ...
            title="Back"
            className="flex h-10 w-10 items-center justify-center rounded-full transition-colors hover:bg-black/5 focus-visible:bg-black/5"
          >
