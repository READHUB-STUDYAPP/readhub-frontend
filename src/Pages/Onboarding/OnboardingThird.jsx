  ...
  return (
    <div>
        <div className='py-10 px-3 flex flex-col justify-center items-center gap-15'>
            ...
            <div className='mt-25'><img src={ReadHubImages.onboardImg2} alt="" /></div>
            <div className='mt-15 flex flex-col items-center text-center gap-2'><span className="text-blue-500 text-2xl font-semibold">Read at your pace</span><span className='text-base font-normal text-gray-950'>Pick up where you left off and keep track of your <br /> progress as you read</span></div>
