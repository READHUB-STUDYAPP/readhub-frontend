  ...
  return (
    <div>
        <div className='py-10 px-3 flex flex-col justify-center items-center gap-15'>
            <div className='flex flex-col items-end gap-3'><span><img src={ReadHubImages.loading1} alt="" /></span><span className='text-sm'>Skip</span></div>
            ...
            <div className='mt-5'><span className='bg-blue-600 py-3 px-25 rounded-4xl text-gray-50'>Next</span></div>
        </div>
    </div>
  )
}
