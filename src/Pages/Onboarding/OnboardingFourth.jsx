  ...
  return (
    <div>
        <div className='py-10 px-3 flex flex-col justify-center items-center gap-15'>
            ...
            <div className='mt-25'><img src={ReadHubImages.onboardImg3} alt="" /></div>
            <div className='mt-15 flex flex-col items-center text-center gap-2'><span className="text-blue-500 text-2xl font-semibold">Read more. Stay consistent</span><span className='text-base font-normal text-gray-950'>Set reading goals and keep yourself motivated<br />one page at a time</span></div>
